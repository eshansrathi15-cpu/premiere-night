...
const Footer = () => {
  ...
  return <footer className="relative bg-background border-t border-gold/20 pt-16 pb-8 overflow-hidden">
      {/* Background Effects */}
          ...
          once: true
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="font-heading text-sm text-muted-foreground tracking-[0.2em]">A CEL PRODUCTION</p>
              </div>
            </div>
          ...
          delay: 0.2
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:eweek@pilani.bits-pilani.ac.in" className="text-muted-foreground text-sm hover:text-gold transition-colors font-heading">
...
const FooterLink = ({
  ...
  children: React.ReactNode;
    ...
    <a href={href} className="text-muted-foreground text-sm hover:text-gold transition-colors font-heading tracking-wider">
      {children}
    </a>
  </li>;
const SocialLink = ({
  ...
  icon: any;
  label: string;
}) => <a href={href} aria-label={label} className="w-10 h-10 flex items-center justify-center rounded-full border border-gold/30 hover:border-gold hover:bg-gold/10 text-muted-foreground hover:text-gold transition-all duration-300">
