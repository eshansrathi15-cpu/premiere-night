      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4 tracking-wide">
            The <span className="text-gold text-glow">Festival Lineup</span>
          </h2>
    ...
    >
      ...
      <div className={`p-6 ${colors.bg} border-b border-border/50`}>
        <div className="flex items-start justify-between">
          ...
          {event.rating && (
            <span className={`text-xs font-heading uppercase tracking-wider px-2 py-1 rounded border ${colors.badge}`}>
              {event.rating}
            </span>
          )}
        </div>
      ...
      <div className="p-6">
        ...
        {event.category !== "coming" && (
          <Button
            variant={event.category === "action" ? "premiere" : event.category === "drama" ? "golden" : "green"}
            size="sm"
        ...
        {event.category === "coming" && (
          <div className="text-center py-2 text-muted-foreground font-heading text-sm italic">
