...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/3 w-72 h-72 bg-velvet/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: "3s"
      }} />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        duration: 1
          ...
          {[...Array(5)].map((_, i) => <Star key={i} className="w-4 h-4 text-gold fill-gold" style={{
        ...
        delay: 0.2
          ...
          <span className="inline-block px-6 py-2 border border-gold/40 rounded-full text-gold font-heading text-sm uppercase tracking-[0.3em] bg-background/40 backdrop-blur-sm"> CEL PRODUCTION PRESENTS</span>
        </motion.div>
