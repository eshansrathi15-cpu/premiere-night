...
const BedrockSection = () => {
  return <section id="bedrock" className="relative py-24 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-cover bg-center opacity-50" style={{
      backgroundImage: `url(${bedrockBg})`
    }} />
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.8
            ...
            <div className="relative bg-card/60 border-2 border-gold/40 rounded-lg p-8 backdrop-blur-sm shadow-glow">
              ...
              <div className="space-y-5">
                <StepCard number="I" title="The Takeover" description="Your team seizes control of a campus restaurant for one dramatic day." />
                <StepCard number="II" title="The Strategy" description="Deploy cunning marketing tactics and irresistible offers." />
                <StepCard number="III" title="The Performance" description="Run operations, serve customers, deliver an unforgettable experience." />
                <StepCard number="IV" title="The Glory" description="Maximum profits win the crown. History remembers the victors." />
              </div>
            </div>
          ...
          duration: 0.8
            ...
            <p className="font-display text-2xl text-foreground/80 mb-2 italic">The C'Not Takeover</p>
