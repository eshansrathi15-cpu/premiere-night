...
const DeHackSection = () => {
  return <section id="dehack" className="relative py-24 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-cover bg-center opacity-40" style={{
      backgroundImage: `url(${dehackBg})`
    }} />
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.8
            ...
            {/* Description */}
            <p className="text-muted-foreground mb-8 leading-relaxed font-heading">The ultimate  hackathon saga. Like the greatest thrillers, every moment counts. Your team writes the screenplay, directs the action, and delivers a blockbuster innovation that leaves the audience speechless.</p>
